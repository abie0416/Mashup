...
**
** Created: Thu May 19 10:18:03 2011
...
static const char qt_meta_stringdata_MediaKeysObserver[] = {
    "MediaKeysObserver\0\0key\0"
    "mediaKeyPressed(MediaKeysObserver::MediaKeys)\0"
};
...
int MediaKeysObserver::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: mediaKeyPressed((*reinterpret_cast< MediaKeysObserver::MediaKeys(*)>(_a[1]))); break;
        default: ;
        }
        _id -= 1;
    }
...
// SIGNAL 0
void MediaKeysObserver::mediaKeyPressed(MediaKeysObserver::MediaKeys _t1)
{
